...
void VerificationLoop() {
	...
	loop_start: {
			...
			instance.DG1_StopReq = nondet_bool();
			goto l_main_call;
		if (false) {
			goto end;
		}
	...
	callEnd: {
		...
		return;  			}
	prepare_EoC: {
		assert((!(EoC) || (((! (((instance.DG1_Remote && instance.CB1_Opened) && instance.DG1_RunRated) && instance.DG1_StopReq)) || instance.DG1_ReadyToStart) && ((0 <= instance.CYCLE) && (instance.CYCLE <= 20)))));
