...
void VerificationLoop() {
	...
	callEnd: {
		...
		return;  			}
	prepare_EoC: {
		assert((!(EoC) || (((! (((instance.DG1_RunRated && instance.CB1_Remote) && (instance.DG1_Voltage == instance.DG1_pNominalVoltage)) && instance.CB1_Close)) || instance.CB1_Closed) && ((0 <= instance.CYCLE) && (instance.CYCLE <= 20)))));
