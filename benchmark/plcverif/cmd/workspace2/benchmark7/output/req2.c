...
void VerificationLoop() {
	...
	init2: {
		...
		return;  			}
	loop_start: {
			instance.INPUT1 = nondet_int32_t();
			instance.INPUT2 = nondet_int32_t();
			instance.INPUT3 = nondet_int32_t();
			instance.INPUT4 = nondet_int32_t();
			instance.INPUT5 = nondet_int32_t();
			instance.INPUT6 = nondet_int32_t();
			instance.INPUT7 = nondet_int32_t();
			goto l_main_call;
		if (false) {
			goto end;
		}
