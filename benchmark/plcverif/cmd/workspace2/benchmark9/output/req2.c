...
void POSITIVEEdge(__POSITIVEEdge *__context) {
	...
	l111: {
			...
			// Assign outputs
			___nested_ret_val29 = BOOL_TO_DINT1_inlined_43.RET_VAL;
			goto l26;
		//assert(false);
		return;  			}
	l26: {
			...
			// Assign outputs
			___nested_ret_val31 = BOOL_TO_DINT1_inlined_44.RET_VAL;
			goto l34;
		//assert(false);
		return;  			}
	l34: {
...
void VerificationLoop() {
	...
	callEnd: {
		...
		return;  			}
	prepare_EoC: {
		assert((!(EoC) || (((! instance.MA_BULL) || instance.MA_BU) && ((0 <= instance.CYCLE) && (instance.CYCLE <= 20)))));
