...
void MA(__MA *__context) {
	...
	l144: {
			...
			// Assign outputs
			___nested_ret_val4 = BOOL_TO_DINT1_inlined_2.RET_VAL;
			goto l145;
		//assert(false);
		return;  			}
	l145: {
	...
	l147: {
			...
			// Assign outputs
			___nested_ret_val5 = BOOL_TO_DINT1_inlined_3.RET_VAL;
			goto l148;
		//assert(false);
		return;  			}
	l148: {
	...
	l171: {
			...
			// Assign outputs
			___nested_ret_val6 = BOOL_TO_DINT1_inlined_5.RET_VAL;
			goto l172;
		//assert(false);
		return;  			}
	l172: {
	...
	l174: {
			...
			// Assign outputs
			___nested_ret_val7 = BOOL_TO_DINT1_inlined_6.RET_VAL;
			goto l175;
		//assert(false);
		return;  			}
	l175: {
	...
	l329: {
			...
			// Assign outputs
			___nested_ret_val8 = BOOL_TO_DINT1_inlined_8.RET_VAL;
			goto l330;
		//assert(false);
		return;  			}
	l330: {
	...
	l332: {
			...
			// Assign outputs
			___nested_ret_val9 = BOOL_TO_DINT1_inlined_9.RET_VAL;
			goto l333;
		//assert(false);
		return;  			}
	l333: {
	...
	l346: {
			...
			// Assign outputs
			___nested_ret_val10 = BOOL_TO_DINT1_inlined_11.RET_VAL;
			goto l347;
		//assert(false);
		return;  			}
	l347: {
	...
	l349: {
			...
			// Assign outputs
			___nested_ret_val11 = BOOL_TO_DINT1_inlined_12.RET_VAL;
			goto l350;
		//assert(false);
		return;  			}
	l350: {
	...
	l373: {
			...
			// Assign outputs
			___nested_ret_val12 = BOOL_TO_DINT1_inlined_14.RET_VAL;
			goto l374;
		//assert(false);
		return;  			}
	l374: {
	...
	l376: {
			...
			// Assign outputs
			___nested_ret_val13 = BOOL_TO_DINT1_inlined_15.RET_VAL;
			goto l377;
		//assert(false);
		return;  			}
	l377: {
	...
	l387: {
			...
			// Assign outputs
			___nested_ret_val14 = BOOL_TO_DINT1_inlined_17.RET_VAL;
			goto l388;
		//assert(false);
		return;  			}
	l388: {
	...
	l390: {
			...
			// Assign outputs
			___nested_ret_val15 = BOOL_TO_DINT1_inlined_18.RET_VAL;
			goto l391;
		//assert(false);
		return;  			}
	l391: {
	...
	l417: {
			...
			// Assign outputs
			___nested_ret_val16 = BOOL_TO_DINT1_inlined_20.RET_VAL;
			goto l418;
		//assert(false);
		return;  			}
	l418: {
	...
	l420: {
			...
			// Assign outputs
			___nested_ret_val17 = BOOL_TO_DINT1_inlined_21.RET_VAL;
			goto l421;
		//assert(false);
		return;  			}
	l421: {
	...
	l431: {
			...
			// Assign outputs
			___nested_ret_val18 = BOOL_TO_DINT1_inlined_23.RET_VAL;
			goto l432;
		//assert(false);
		return;  			}
	l432: {
	...
	l434: {
			...
			// Assign outputs
			___nested_ret_val19 = BOOL_TO_DINT1_inlined_24.RET_VAL;
			goto l435;
		//assert(false);
		return;  			}
	l435: {
	...
	l509: {
			...
			// Assign outputs
			___nested_ret_val20 = BOOL_TO_DINT1_inlined_26.RET_VAL;
			goto l510;
		//assert(false);
		return;  			}
	l510: {
	...
	l512: {
			...
			// Assign outputs
			___nested_ret_val21 = BOOL_TO_DINT1_inlined_27.RET_VAL;
			goto l513;
		//assert(false);
		return;  			}
	l513: {
	...
	l523: {
			...
			// Assign outputs
			___nested_ret_val22 = BOOL_TO_DINT1_inlined_29.RET_VAL;
			goto l524;
		//assert(false);
		return;  			}
	l524: {
	...
	l526: {
			...
			// Assign outputs
			___nested_ret_val23 = BOOL_TO_DINT1_inlined_30.RET_VAL;
			goto l527;
		//assert(false);
		return;  			}
	l527: {
	...
	l557: {
			...
			// Assign outputs
			___nested_ret_val24 = BOOL_TO_DINT1_inlined_32.RET_VAL;
			goto l558;
		//assert(false);
		return;  			}
	l558: {
	...
	l560: {
			...
			// Assign outputs
			___nested_ret_val25 = BOOL_TO_DINT1_inlined_33.RET_VAL;
			goto l561;
		//assert(false);
		return;  			}
	l561: {
	...
	l571: {
			...
			// Assign outputs
			___nested_ret_val26 = BOOL_TO_DINT1_inlined_35.RET_VAL;
			goto l572;
		//assert(false);
		return;  			}
	l572: {
	...
	l574: {
			...
			// Assign outputs
			___nested_ret_val27 = BOOL_TO_DINT1_inlined_36.RET_VAL;
			goto l575;
		//assert(false);
		return;  			}
	l575: {
	...
	l585: {
			...
			// Assign outputs
			___nested_ret_val28 = BOOL_TO_DINT1_inlined_38.RET_VAL;
			goto l586;
		//assert(false);
		return;  			}
	l586: {
	...
	l588: {
			...
			// Assign outputs
			___nested_ret_val29 = BOOL_TO_DINT1_inlined_39.RET_VAL;
			goto l589;
		//assert(false);
		return;  			}
	l589: {
			__context->rowIdx = ((__context->rowIdx * 2) + ___nested_ret_val29);
	...
	l599: {
			...
			// Assign outputs
			___nested_ret_val30 = BOOL_TO_DINT1_inlined_41.RET_VAL;
			goto l600;
		//assert(false);
		return;  			}
	l600: {
			__context->rowIdx = ((__context->rowIdx * 2) + ___nested_ret_val30);
	...
	l602: {
			...
			// Assign outputs
			___nested_ret_val31 = BOOL_TO_DINT1_inlined_42.RET_VAL;
			goto l603;
		//assert(false);
		return;  			}
	l603: {
			__context->rowIdx = ((__context->rowIdx * 2) + ___nested_ret_val31);
...
void POSITIVEEdge(__POSITIVEEdge *__context) {
	...
	l111: {
			...
			// Assign outputs
			___nested_ret_val1 = BOOL_TO_DINT1_inlined_43.RET_VAL;
			goto l26;
		//assert(false);
		return;  			}
	l26: {
			...
			// Assign outputs
			___nested_ret_val3 = BOOL_TO_DINT1_inlined_44.RET_VAL;
			goto l34;
		//assert(false);
		return;  			}
	l34: {
		...
		return;  			}
	l45: {
			__context->OUT = (___nested_ret_val1 > ___nested_ret_val2);
			goto l5;
		//assert(false);
		return;  			}
	l5: {
...
void NEGATIVEEdge(__NEGATIVEEdge *__context) {
	...
	l112: {
			...
			// Assign outputs
			___nested_ret_val32 = BOOL_TO_DINT1_inlined_45.RET_VAL;
			goto l210;
		//assert(false);
		return;  			}
	l210: {
			...
			// Assign outputs
			___nested_ret_val34 = BOOL_TO_DINT1_inlined_46.RET_VAL;
			goto l35;
		//assert(false);
		return;  			}
	l35: {
...
void VerificationLoop() {
	...
	callEnd: {
		...
		return;  			}
	prepare_EoC: {
		assert((!(EoC) || (((! instance.MA_BB) || (! instance.MA_YF)) && ((0 <= instance.CYCLE) && (instance.CYCLE <= 20)))));
